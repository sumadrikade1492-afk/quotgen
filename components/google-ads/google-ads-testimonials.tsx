const testimonials = [
  {
    name: 'David Martinez',
    title: 'Director, E-commerce Company',
    text: 'Cut our advertising costs by 40% while increasing conversions by 150%. Best decision we made for our business.',
    rating: 5,
  },
  {
    name: 'Jessica Lee',
    title: 'Marketing Manager, SaaS',
    text: 'Professional, responsive, and results-driven. Our ROAS improved dramatically. Couldn\'t ask for a better partner.',
    rating: 5,
  },
  {
    name: 'Tom Wilson',
    title: 'Owner, Local Service Business',
    text: 'Went from struggling with ads to having a predictable lead generation machine. This team knows Google Ads inside and out.',
    rating: 5,
  },
]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#6B7280] max-w-2xl mx-auto">
            See what businesses across all industries achieve with our Google Ads management
          </p>
        </div>
