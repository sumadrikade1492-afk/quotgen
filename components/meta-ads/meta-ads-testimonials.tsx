const testimonials = [
  {
    ...
    text: 'My Instagram ads were underperforming until this team took over. 3x return on ad spend within 6 weeks. They know the Meta platform inside and out.',
    rating: 5,
  },
  {
    name: 'David Thompson',
    title: 'CEO, E-commerce Company',
    text: 'Went from 2.1x to 4.8x ROAS. The detailed optimization reports help me understand exactly what\'s working. Highly recommend!',
    rating: 5,
  },
  {
    name: 'Sarah Chen',
    title: 'Marketing Manager, SaaS',
    text: 'Cost per acquisition dropped 60% while maintaining conversions. Their strategic approach to audience targeting is exceptional.',
    rating: 5,
  },
]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#6B7280] max-w-2xl mx-auto">
            Real results from businesses across all industries
          </p>
        </div>
