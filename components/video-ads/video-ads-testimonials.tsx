const testimonials = [
  {
    ...
    text: 'Their videos increased our product sales by 450%. The team understood our brand and delivered exactly what we needed.',
    rating: 5,
  },
  {
    name: 'Jennifer Lee',
    title: 'SaaS Startup CEO',
    text: 'Professional videos at affordable prices. They turned our complex product into engaging explainer content that converts.',
    rating: 5,
  },
  {
    name: 'David Chen',
    title: 'Digital Marketing Agency',
    text: 'We now offer video production to our clients through their service. Game changer for our agency.',
    rating: 5,
  },
]

export function VideoAdsTestimonials() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#6B7280] max-w-2xl mx-auto">
            Hear from businesses that transformed with video marketing
          </p>
        </div>
